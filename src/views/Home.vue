<template >
  ...
  <div class="container px-5 py-14 mx-auto">
    <div class="flex flex-col text-center w-full mb-8">
      ...
      <!-- get free games button -->
      <div class="flex justify-center py-4">
      <router-link :to="{name :'FreeGames'}" class="custom-btn btn-5 "><span>Game Giveaways</span></router-link>
      </div>
...
background: linear-gradient(0deg, rgb(71, 187, 223) 0%, rgb(46, 211, 240) 100%);
}
.btn-5:hover {
  color: #90ddf0;
  background: transparent;
